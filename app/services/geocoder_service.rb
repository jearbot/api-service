...
# My thoughts here on how to reduce API calls would be:
	...
	# In this implementation the rides belong to drivers so would likely be duplicate rides.
	# We could set this up another way to have rides have many drivers.
	# Then the attributes like earnings and score that are stored, we could calculate those on the fly.
